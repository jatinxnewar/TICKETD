...
const buttonVariants = cva(
  [
    ...
    // A slight press keeps clicks feeling responsive without motion noise.
    "active:scale-[0.98]",
  ...
  ],
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background shadow-subtle hover:bg-accent hover:text-accent-foreground hover:border-primary/30",
